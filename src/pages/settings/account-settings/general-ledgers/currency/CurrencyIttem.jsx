...
export default function GeneralLedgerCurrencyIttem() {
  const [isOpen, setIsOpen] = useState(false);
  return (
    <div className="w-full flex items-center pt-4 pb-2 border-b">
      <Title title="34567543" width="w-[10%]" />
      <Title title="NGN" width="w-[15%]" />
      <Title title="556" width="w-[15%]" />
      <Title title="NAIRA" width="flex-1" />
      <Title title="1-SEPT-2024" width="w-[15%]" />
