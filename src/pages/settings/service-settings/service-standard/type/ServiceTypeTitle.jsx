export default function ServiceTypeTitle() {
  return (
    <div className="w-full flex items-center pt-4 pb-2 border-b">
      ...
      <Title title="DURATION" width="w-[10%] hidden lg:block" />
      <Title title="IMPACT" width="w-[10%] hidden lg:block" />
      <Title title="URGENCY" width="w-[10%] hidden lg:block" />
      <Title title="PRIORITY" width="w-[10%] hidden lg:block" />
