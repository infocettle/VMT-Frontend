  ...
  return (
    <div className="w-full">
      ...
      <Link to="/access_control/modules/groups/detail_groups">
        ...
        {/* Table */}
        <ReusableTablePolicy columns={accessControlModuleGroupColumns} data={sampleDataModules} tableParent={"user_profiles"}  tableName={"roles"} tableChild={"detail_roles"}  />
      </div>
    </div>
  );
};
