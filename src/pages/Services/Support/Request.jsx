...
const tableRows = [
    {
        requestid: "LOGIN ISSUE",
        requesttype: "90176",
        datelogged: "In publishing and graphic design, Lorem ipsum is a placeholder text commonly used to...",
        timelogged: "TIMELINESS",
        requesterid: "2HR",
        details: "2HR",
        status: <p className="status-badge no-border status-badge--ofsted--outstanding text-center py-1" style={{ width: "71px", fontSize:"11px" }}>
            Successful
        </p>,
        action: <Space>
