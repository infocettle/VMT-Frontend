...
export default function GeneralLedgersTypeItem() {
  ...
  return (
    <div className="w-full flex items-center py-4 border-b">
      <Title title="100110" width="w-[10%]" />
      <Title title="CASH BALANCES" width="flex-1 uppercase" />
      <Title title="CURRENT ASSET" width="w-[15%]" />
