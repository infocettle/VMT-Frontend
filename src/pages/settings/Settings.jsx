...
import { Earth, Minus, Plus, Settings } from "lucide-react";
        ...
        <Collapsible
            ...
            <CollapsibleTrigger asChild>
              <div className="w-full flex items-center justify-between">
                <div className="w-auto flex items-center space-x-2">
                  {isOpen ? (
                    <Settings color="#0B6ED0" size={15} />
                  ) : (
                    <Settings color="#000" size={15} />
                  )}
          ...
          <CollapsibleContent>
            <div className="w-full flex flex-col items-center space-y-2 px-3 py-2">
              ...
              {ServiceSettings.map((modules) => (
                <Reusable modules={modules} key={modules.id} />
              ))}

              {AccountSettings.map((modules) => (
                <Reusable modules={modules} key={modules.id} />
              ))}
            </div>
          </CollapsibleContent>
