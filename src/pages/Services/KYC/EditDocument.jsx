                ...
                <div className="flex justify-between w-full items-center">
                    <div className="main-container">
                        <div class="flex justify-between">
                            <div>
                                <h2 className="performance_header flex"><Link to={"/services/contacts/kycverification"} className="mr-2"><BiLeftArrowAlt size={20} /></Link> Trading</h2>
                            </div>
                        </div>
