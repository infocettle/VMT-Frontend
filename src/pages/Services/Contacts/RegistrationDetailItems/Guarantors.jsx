...
export default function Guarantors() {
  return (
    ...
    <h3 style={{ color: "#8E8EA9", fontWeight: "500", fontSize: "15px" }} className="mb-1">Guarantor</h3>
    <Divider style={{ margin: 1 }} />
    <div className="mt-4">
        <div className="flex space-x-4">
            <div className="w-1/2">
                <p style={{ fontSize: "16px",  }} className='mb-2'>First Guarantor</p>
            ...
            <div className="w-1/2">
                <p style={{ fontSize: "16px" }} className='mb-2'>Second Guarantor</p>
                <div className="grid grid-cols-4 gap-x-4 space-y-2">
                    <div className="col-span-3 space-y-2">
                        <div className="flex">
                            <div className="flex-1 font-bold leading-relaxed" style={{ fontSize: "14px" }}>Title</div>
