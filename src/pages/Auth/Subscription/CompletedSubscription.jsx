...
function CompletedSubscription({ setSubscriptionType }) {
  ...
  const handleDashboard = () => {
    if (userType === "companySubscriber") {
      navigate("/profile/company-subscriber");
    }
    if (userType === "companyPartner") {
      navigate("/profile/company-partner");
    }
    if (userType === "individualSubscriber") {
      navigate("/profile/individual-subscriber");
    }
    if (userType === "individualPartner") {
      navigate("/profile/individual-partner");
    }
  };
  ...
  return (
    <div className="sub-form-container">
      <div
        className="sub-form flex justify-center items-center "
        style={{ height: "82vh", margin: "3rem auto" }}
      >
        <div
        ...
        >
          ...
          <div className="auth-subheader-text mt-4 mb-7 text-center">
            You have completed you first subscription, you can now access the
            features and perform various action on the application
          </div>
          <div
